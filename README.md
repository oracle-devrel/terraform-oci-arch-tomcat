...
* [examples](examples): This folder contains examples of how to use the module:
  ...
  - [tomcat multi-node + custom network + Bastion Service injected into module](examples/tomcat-ha-mds-use-existing-network-and-injected-bastion-service): This is an example of how to use the oci-arch-tomcat module to deploy tomcat HA (multi-node) with network cloud infrastrucutre elements + Bastion Service injected into the module.
